...
<div style="display: flex; gap: 20px; margin: 20px 0; flex-wrap: wrap;"> <div style="flex: 1; min-width: 150px; background-color: #2874a6; padding: 16px; border-radius: 10px; text-align: center;"> <div style="color: white; font-size: 14px; text-transform: uppercase; letter-spacing: 1px;">BLEU</div> <div style="background-color: #d4e6f1; padding: 10px; border-radius: 8px; margin-top: 8px; font-size: 28px; font-weight: bold; color: #1a5276;">20.01</div> </div> <div style="flex: 1; min-width: 150px; background-color: #1e8449; padding: 16px; border-radius: 10px; text-align: center;"> <div style="color: white; font-size: 14px; text-transform: uppercase; letter-spacing: 1px;">METEOR</div> <div style="background-color: #d5f5e3; padding: 10px; border-radius: 8px; margin-top: 8px; font-size: 28px; font-weight: bold; color: #145a32;">0.3927</div> </div> <div style="flex: 1; min-width: 150px; background-color: #b9770e; padding: 16px; border-radius: 10px; text-align: center;"> <div style="color: white; font-size: 14px; text-transform: uppercase; letter-spacing: 1px;">TER</div> <div style="background-color: #fdebd0; padding: 10px; border-radius: 8px; margin-top: 8px; font-size: 28px; font-weight: bold; color: #7e5109;">1.0747</div> </div></div>
